...
import { M as Menu$1 } from '../chunks/Menu_DumWImAm.mjs';
...
import { getContrastRatio, lighten, darken, private_safeDarken, private_safeLighten, private_safeEmphasize, private_safeAlpha, private_safeColorChannel, hslToRgb, alpha } from '@mui/system/colorManipulator';
import { unstable_createGetCssVar, createSpacing, useTheme as useTheme$1, GlobalStyles as GlobalStyles$1, unstable_memoTheme, keyframes, css } from '@mui/system';
...
function Busqueda() {
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-row justify-center items-center mt-10 mb-10 text-white space-x-4", children: [
    /* @__PURE__ */ jsx(
      TextField,
      {
        id: "outlined-basic",
        label: "Introduzca una palabra",
        variant: "outlined",
        size: "medium",
        sx: { height: "56px" }
      }
...
const $$Buscar = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Main, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Menu", Menu$1, {})} ${renderComponent($$result2, "Busqueda", Busqueda, { "client:load": true, "client:component-hydration": "load", "client:component-path": "@/components/Busqueda", "client:component-export": "default" })} ${maybeRenderHead()}<footer class="mt-12 bg-gray-100 dark:bg-gray-800 py-6 px-4 rounded-lg shadow text-center"> <p class="text-gray-600 dark:text-gray-300 text-sm">© 2023 - Todos los derechos reservados</p> <p class="text-gray-500 dark:text-gray-400 text-xs mt-1">
Desarrollado por
<a href="http://github.com/SergioHrvas" class="text-blue-600 dark:text-blue-400 hover:underline ml-1">Sergio</a> </p> </footer> ` })}`;
}, "/home/sergio/Documentos/Master/SSBW/astro-app/src/pages/buscar.astro", void 0);

const $$file = "/home/sergio/Documentos/Master/SSBW/astro-app/src/pages/buscar.astro";
const $$url = "/buscar";
